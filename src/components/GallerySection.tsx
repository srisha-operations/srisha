          ...
          <div className="space-y-16 md:space-y-24 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
              <div className="w-full aspect-[4/5] overflow-hidden">
                <img
                  src={images.gallery.portrait_left.path}
                  alt={images.gallery.portrait_left.alt}
              ...
              <div className="flex flex-col justify-center space-y-4 px-4 md:px-8">
                <h3 className="text-2xl md:text-3xl font-tenor text-foreground leading-relaxed">
                  {content.gallery.blocks.portrait_left.title}
                </h3>
                <p className="text-base md:text-lg font-lato text-muted-foreground leading-relaxed">
                  {content.gallery.blocks.portrait_left.caption}
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
              {images.gallery.three_grid.map((image) => (
                <div key={image.id} className="w-full aspect-[9/16] overflow-hidden">
                  <img
                    src={image.path}
                    alt={image.alt}
                    className="w-full h-full object-cover object-center"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
              <div className="flex flex-col justify-center space-y-4 px-4 md:px-8 md:order-1">
                <h3 className="text-2xl md:text-3xl font-tenor text-foreground leading-relaxed">
                  {content.gallery.blocks.portrait_right.title}
                </h3>
                <p className="text-base md:text-lg font-lato text-muted-foreground leading-relaxed">
                  {content.gallery.blocks.portrait_right.caption}
                </p>
              </div>
              <div className="w-full aspect-[3/4] overflow-hidden md:order-2">
                <img
                  src={images.gallery.portrait_right.path}
                  alt={images.gallery.portrait_right.alt}
                  className="w-full h-full object-cover object-center"
                />
              </div>
            </div>
            ...
            <div className="relative w-full aspect-video overflow-hidden">
              <img
                src={images.gallery.final_cta.path}
                alt={images.gallery.final_cta.alt}
                className="w-full h-full object-cover object-center"
              />
